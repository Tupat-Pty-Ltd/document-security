...
class DigitalSignature:
    ...
    def create_self_signed_cert(self, pKey):
        """Create a self signed certificate.
        This certificate will not require to be signed by a Certificate Authority.
        """
        # Create a self signed certificate
    ...
    def sign_file(self, input_file: str, signatureID: str, x_coordinate: int, 
